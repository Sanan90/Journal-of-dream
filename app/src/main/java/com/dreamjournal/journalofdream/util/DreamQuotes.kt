...
,
    "uk" to listOf(
        "Усвідомлений сон — це двері до безмежних можливостей твого розуму.",
        "Уві сні ти можеш літати. Усвідом це — і небо стане твоїм.",
        "Кожен сон — це послання від твого підсвідомості. Вмій його читати.",
        "Той, хто вміє бачити усвідомлені сни, живе два життя.",
        "Сон — це не відпочинок. Це подорож всередину себе.",
        "Записуй сни — і вони стануть яскравішими та багатшими.",
        "Межа між сном і реальністю — лише питання усвідомленості.",
        "Практикуй усвідомленість вдень — і вона прийде до тебе вночі.",
        "Твій мозок створює цілі світи поки ти спиш. Увійди в них усвідомлено.",
        "Найкращий спосіб передбачити майбутнє — створити його. Навіть уві сні."
    ),
    "kk" to listOf(
        "Саналы арман — бұл зіңнің шексіз мүмкіндіктеріне ашылатын есік.",
        "Арманда ұша аласың. Мұны сезін — аспан сеникі болады.",
        "Әр арман — санадан тыс жіберілген хабар. Оны оқуды үйрен.",
        "Саналы арман көре алатын адам екі өмір сүреді.",
        "Ұйқы демалыс емес. Бұл өз ішіңе сапар.",
        "Армандарыңды жаз — олар жарқынырақ және байырақ болады.",
        "Арман мен шындық арасындағы шекара тек санасыздық мәселесі.",
        "Күндіз саналылықты жаттық — түнде ол сенің қасыңа келеді.",
        "Ұйықтап жатқанда миың тұтас әлемдер жасайды. Оларға саналы кір.",
        "Болашақты болжаудың ең жақсы жолы — оны жасау. Тіпті арманда да."
    ),
)
